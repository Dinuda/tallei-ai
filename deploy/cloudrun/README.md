...
PROJECT_ID="your-project-id" ./deploy/cloudrun/add-secret-versions.sh \
  ...
  GOOGLE_CLIENT_SECRET TALLEI_BILLING__LEMONSQUEEZY_API_KEY \
  TALLEI_BILLING__LEMONSQUEEZY_WEBHOOK_SECRET SUPABASE_SERVICE_ROLE_KEY QDRANT_API_KEY
```
...
export DASHBOARD_GRAPH_V2_ENABLED="true"
export RECALL_V2_ENABLED="true"
...
export TALLEI_BILLING__LEMONSQUEEZY_WEBHOOK_SECRET="TALLEI_BILLING__LEMONSQUEEZY_WEBHOOK_SECRET"
export TALLEI_BILLING__LEMONSQUEEZY_PRO_VARIANT_ID="12345"
export TALLEI_BILLING__LEMONSQUEEZY_POWER_VARIANT_ID="67890"
