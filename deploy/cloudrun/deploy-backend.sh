...
require_env TALLEI_SIGNUP__SLACK_WEBHOOK_URL
...
validate_secret_id TALLEI_SIGNUP__SLACK_WEBHOOK_URL
...
ensure_secret_access TALLEI_SIGNUP__SLACK_WEBHOOK_URL
...
if [[ -n "${TALLEI_AUTH__API_KEY_PEPPER:-}" ]]; then
  validate_secret_id TALLEI_AUTH__API_KEY_PEPPER
