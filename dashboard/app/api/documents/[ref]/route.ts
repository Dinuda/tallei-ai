...
export async function GET(
  ...
  try {
    const res = await fetchWithTimeout(`${backend}/api/documents/${encodeURIComponent(ref)}`, {
      headers: {
    ...
    return Response.json(
      {
        error: isAbort
          ? "Timed out contacting backend /api/documents/:ref"
          : "Failed to reach backend /api/documents/:ref",
      },
