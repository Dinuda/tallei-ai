...
export async function POST(
  ...
  try {
    const res = await fetchWithTimeout(
      `${backend}/api/memories/import/chatgpt/${encodeURIComponent(ref)}/persist`,
      {
        method: "POST",
        headers: {
    ...
    return Response.json(
      {
        error: isAbort
          ? "Timed out contacting backend /api/memories/import/chatgpt/:ref/persist"
          : "Failed to reach backend /api/memories/import/chatgpt/:ref/persist",
      },
