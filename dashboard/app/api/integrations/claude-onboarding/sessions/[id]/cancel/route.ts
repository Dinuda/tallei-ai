...
export async function POST(
  ...
  try {
    const res = await fetchWithTimeout(`${backend}/api/claude-onboarding/sessions/${id}/cancel`, {
      method: "POST",
      headers: {
    ...
    return Response.json(
      {
        error: isAbort
          ? "Timed out contacting backend /api/claude-onboarding/sessions/:id/cancel"
          : "Failed to reach backend /api/claude-onboarding/sessions/:id/cancel",
      },
