...
function backendHeaders(userId: string, withJson = false) {
  return {
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    return Response.json(
      {
        error: isAbort
          ? "Timed out contacting backend /api/integrations/chatgpt/token"
          : "Failed to reach backend /api/integrations/chatgpt/token",
      },
