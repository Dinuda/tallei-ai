...
export async function GET(req: NextRequest) {
  ...
  try {
    const res = await fetchWithTimeout(`${backend}/api/integration-updates/assets`, {
      headers: {
    ...
    return Response.json(
      {
        error: isAbort
          ? "Timed out contacting backend /api/integration-updates/assets"
          : "Failed to reach backend /api/integration-updates/assets",
      },
