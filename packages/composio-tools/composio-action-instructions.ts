import type {
  ...
  ComposioArgResolutionPlan,
  ResolvedToolLike,
} from "./contract-types.js";
import { getTriggerOutputFields } from "./trigger-known-fields.js";
...
export function mergeComposioActionInstructions(input: {
  ...
  tools: Array<Pick<ResolvedToolLike, "connector" | "actionSlug" | "inputSchema" | "outputSchema"> & { capability?: string }>;
}): ComposioActionInstruction[] {
...
export function attachComposioActionInstructionsToTools<T extends Pick<ResolvedToolLike, "connector" | "actionSlug">>(
  tools: T[],
...
export function validateComposioActionInstructions(input: {
  tools: Array<Pick<ResolvedToolLike, "connector" | "actionSlug" | "inputSchema">>;
  instructions: ComposioActionInstruction[];
...
function valueFromToolHistory(input: {
  plan: ComposioArgResolutionPlan;
  actionSlug?: string;
  path?: string;
