...
} from "../runtime/connector-action-payload.js";
import { nextCronRunAt } from "../domain/schedule-cron.js";
import { hydrateDefinitionForExecution, resolveBuildContract, resolveDiscoveredToolContracts } from "../runtime/definition-hydration.js";
import { parseLoopDefinition } from "../runtime/spec-run-types.js";
import type { LoopDefinition } from "../workflow/types.js";
import { scheduleTriggerLabel } from "../runtime/spec-runner.js";
...
import { loadWorkflowWorkspaceId } from "../runtime/resolve-loop-run-auth.js";
...
export async function runWorkflowVerification(auth: AuthContext, workflowId: string): Promise<WorkflowVerificationView> {
  ...
  let workflowBuildContract: import("../domain/build-contract.js").AnyLoopBuildContract | null = null;
