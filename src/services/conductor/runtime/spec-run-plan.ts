...
import type { InputRequirement, InputSurface } from "../contracts/input-surfaces.js";
import type { AgentPersona, NoSlopSpecAgent } from "../contracts/spec-contracts.js";
...
import { actionSlugFromToolRef, contractActionSlug } from "../domain/tool-roles.js";
