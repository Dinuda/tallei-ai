...
function buildArchitectSystemPrompt(): string {
    ...
    agents: [
      {
        ...
        task: "Search memories for product updates and voice/style signals.",
        tool: "internal.memory_search",
        inputContract: { description: "Loop goal and search query", schema: { query: "string" } },
        outputContract: { description: "Verified memories with ids", schema: { memories: [{ id: "string", excerpt: "string" }] } },
  ...
  return [
    ...
    'For email or newsletter writing agents, set renderTarget: "canvas.email". This is NOT a tool and must not appear in tool.',
