...
3. VISIBILITY GUARANTEE: After collab_take_turn succeeds, include the actual submitted output content in the assistant reply. Do not reply with only status text like "completed." If a collab tool returns continue_command, end the reply with its label and command.
