...
const ALIAS_MAP: ReadonlyArray<{ newKey: string; oldKey: string }> = [
  ...
  { newKey: "TALLEI_LLM__ANTHROPIC_API_KEY",    oldKey: "ANTHROPIC_API_KEY" },
  ...
  { newKey: "TALLEI_LOOP_MINER__EVALUATOR_MODEL", oldKey: "LOOP_MINER_EVALUATOR_MODEL" },
  { newKey: "TALLEI_LOOP_MINER__DNA_MODEL", oldKey: "LOOP_MINER_DNA_MODEL" },
  ...
  { newKey: "TALLEI_NOTIFICATIONS__WHATSAPP_WEBHOOK_URL",  oldKey: "NOTIFICATIONS_WHATSAPP_WEBHOOK_URL" },
  ...
  { newKey: "TALLEI_CHANNELS__TELEGRAM_BOT_TOKEN", oldKey: "CHANNELS_TELEGRAM_BOT_TOKEN" },
  { newKey: "TALLEI_CHANNELS__TELEGRAM_BOT_USERNAME", oldKey: "CHANNELS_TELEGRAM_BOT_USERNAME" },
  { newKey: "TALLEI_CHANNELS__TELEGRAM_WEBHOOK_SECRET", oldKey: "CHANNELS_TELEGRAM_WEBHOOK_SECRET" },
  { newKey: "TALLEI_CHANNELS__WHATSAPP_OPENWA_URL", oldKey: "CHANNELS_WHATSAPP_OPENWA_URL" },
  { newKey: "TALLEI_CHANNELS__WHATSAPP_OPENWA_TOKEN", oldKey: "CHANNELS_WHATSAPP_OPENWA_TOKEN" },
  { newKey: "TALLEI_CHANNELS__WHATSAPP_SHARED_NUMBER", oldKey: "CHANNELS_WHATSAPP_SHARED_NUMBER" },
  { newKey: "TALLEI_CHANNELS__WHATSAPP_WEBHOOK_TOKEN", oldKey: "CHANNELS_WHATSAPP_WEBHOOK_TOKEN" },
  { newKey: "TALLEI_CHANNELS__RESEND_INBOUND_DOMAIN", oldKey: "CHANNELS_RESEND_INBOUND_DOMAIN" },
  ...
  { newKey: "TALLEI_WORKERS__DAILY_INTELLIGENCE_ENABLED", oldKey: "DAILY_INTELLIGENCE_WORKER_ENABLED" },
  { newKey: "TALLEI_WORKERS__DAILY_INTELLIGENCE_POLL_MS", oldKey: "DAILY_INTELLIGENCE_WORKER_POLL_MS" },
  { newKey: "TALLEI_WORKERS__DAILY_INTELLIGENCE_BATCH_SIZE", oldKey: "DAILY_INTELLIGENCE_WORKER_BATCH_SIZE" },
  { newKey: "TALLEI_NOTIFICATIONS__EMAIL_ADAPTER", oldKey: "NOTIFICATIONS_EMAIL_ADAPTER" },
  { newKey: "TALLEI_NOTIFICATIONS__WHATSAPP_ADAPTER", oldKey: "NOTIFICATIONS_WHATSAPP_ADAPTER" },
  { newKey: "TALLEI_CONNECTORS__COMPOSIO_API_KEY", oldKey: "COMPOSIO_API_KEY" },
  { newKey: "TALLEI_CONNECTORS__COMPOSIO_BASE_URL", oldKey: "COMPOSIO_BASE_URL" },
  { newKey: "TALLEI_CONNECTORS__COMPOSIO_AUTH_CONFIG_ID", oldKey: "COMPOSIO_AUTH_CONFIG_ID" },
  { newKey: "TALLEI_CONNECTORS__COMPOSIO_WEBHOOK_SECRET", oldKey: "COMPOSIO_WEBHOOK_SECRET" },
  { newKey: "TALLEI_CONNECTORS__COMPOSIO_ENTITY_PREFIX", oldKey: "COMPOSIO_ENTITY_PREFIX" },
  { newKey: "TALLEI_CONNECTORS__COMPOSIO_STRICT_MODE", oldKey: "COMPOSIO_STRICT_MODE" },
  { newKey: "TALLEI_CONNECTORS__RESEND_PORTAL_URL", oldKey: "RESEND_PORTAL_URL" },
  { newKey: "TALLEI_CONNECTORS__RESEND_API_KEYS_URL", oldKey: "RESEND_API_KEYS_URL" },
  { newKey: "TALLEI_CONNECTORS__RESEND_DOCS_URL", oldKey: "RESEND_DOCS_URL" },
